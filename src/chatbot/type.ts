...
import type { MessageStatus, ModelServiceState } from './core/type';
...
export type TdChatInputStatus = Extract<MessageStatus, 'sent' | 'pending' | 'streaming'>;
