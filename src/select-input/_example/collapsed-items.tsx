...
export default class SelectInputCollapsedItems extends Component {
  ...
  handleCollapsedItems: SelectInputProps['collapsedItems'] = ({ collapsedSelectedItems }) => {
    if (Array.isArray(collapsedSelectedItems)) {
      return <t-tag key={'More'}>More(+{collapsedSelectedItems.length})</t-tag>;
    }
    return null;
  };
  ...
  render() {
    return (
      <t-space direction="vertical" className="tdesign-demo__select-input-collapsed-items">
        {/* <!-- :popup-props="{ trigger: 'hover' }" --> */}
        <t-select-input
          value={this.value.value}
          minCollapsedNum={1}
          panel={this.CheckboxPanel}
          suffixIcon={<t-icon-chevron-down key="suffixIcon" />}
          clearable
          multiple
        ...
        <t-select-input
          ...
          panel={this.CheckboxPanel}
          suffixIcon={<t-icon-chevron-down key="suffixIcon" />}
          collapsedItems={this.handleCollapsedItems}
          clearable
          multiple
          onTagChange={this.onTagChange}
        />
