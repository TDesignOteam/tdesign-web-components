...
| 旧写法（develop） | 新写法 |
|------------------|--------|
| `tdesign-web-components` | `@tdesign/web-components` |
| `tdesign-web-components/button` | `@tdesign/web-components/button` |
| Chat 与 UI 同包 | Chat 见 `@tdesign/web-components-chat` |

---

## 历史版本（1.2.x 及更早，UI + Chat 合包）
